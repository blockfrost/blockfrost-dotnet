...
namespace Blockfrost.Api.Tests.Services
{
    ...
    public partial class ScriptsServiceTest : AServiceTestBase
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/scripts", "0.1.28")]
        private async Task<Api.Models.ScriptsResponseCollection> GetScriptsAsync(int? count, int? page, ESortOrder? order, CancellationToken cancellationToken)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/scripts/{script_hash}", "0.1.28")]
        private async Task<Api.Models.ScriptResponse> GetScriptsAsync(string script_hash, CancellationToken cancellationToken)
        {
            var sut = Provider.GetRequiredService<Api.Services.IScriptsService>();
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/scripts/{script_hash}/redeemers", "0.1.28")]
        private async Task<Api.Models.ScriptRedeemersResponseCollection> GetRedeemersAsync(string script_hash, int? count, int? page, ESortOrder? order, CancellationToken cancellationToken)
        {
            var sut = Provider.GetRequiredService<Api.Services.IScriptsService>();

...
namespace Blockfrost.Api.Services
{
    public partial interface IPinsService : IBlockfrostService
    {
        ...
        Task<Models.IpfsPinListResponseCollection> GetPinListAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.IpfsPinListIPFSPathResponse> GetPinListAsync(string IPFS_path, CancellationToken cancellationToken = default);
        /// <summary>

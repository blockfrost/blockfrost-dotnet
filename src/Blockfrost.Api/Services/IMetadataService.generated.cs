...
namespace Blockfrost.Api.Services
{
    public partial interface IMetadataService : IBlockfrostService
    {
        ...
        Task<Models.TxMetadataLabelsResponseCollection> GetTxsLabelsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.TxMetadataLabelJsonResponseCollection> GetTxsLabelsAsync(string label, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.TxMetadataLabelCborResponseCollection> GetTxsLabelsCborAsync(string label, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

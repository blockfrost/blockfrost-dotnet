...
namespace Blockfrost.Api.Services
{
    public partial interface IEpochsService : IBlockfrostService
    {
        ...
        Task<EpochContentResponse> GetLatestAsync();
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/latest", "0.1.27")]
        Task<EpochContentResponse> GetLatestAsync(CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochParamContentResponse> GetLatestParametersAsync();
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/latest/parameters", "0.1.27")]
        Task<EpochParamContentResponse> GetLatestParametersAsync(CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochContentResponse> GetEpochsAsync(int number);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}", "0.1.27")]
        Task<EpochContentResponse> GetEpochsAsync(int number, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochContentResponseCollection> GetNextAsync(int number, int? count, int? page);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/next", "0.1.27")]
        Task<EpochContentResponseCollection> GetNextAsync(int number, int? count, int? page, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochContentResponseCollection> GetPreviousAsync(int number, int? count, int? page);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/previous", "0.1.27")]
        Task<EpochContentResponseCollection> GetPreviousAsync(int number, int? count, int? page, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochStakeContentResponseCollection> GetStakesAsync(int number, int? count, int? page);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/stakes", "0.1.27")]
        Task<EpochStakeContentResponseCollection> GetStakesAsync(int number, int? count, int? page, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochStakePoolContentResponseCollection> GetStakesAsync(int number, string pool_id, int? count, int? page);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/stakes/{pool_id}", "0.1.27")]
        Task<EpochStakePoolContentResponseCollection> GetStakesAsync(int number, string pool_id, int? count, int? page, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<StringCollection> GetBlocksAsync(int number, int? count, int? page, ESortOrder? order);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/blocks", "0.1.27")]
        Task<StringCollection> GetBlocksAsync(int number, int? count, int? page, ESortOrder? order, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<StringCollection> GetBlocksAsync(int number, string pool_id, int? count, int? page, ESortOrder? order);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/blocks/{pool_id}", "0.1.27")]
        Task<StringCollection> GetBlocksAsync(int number, string pool_id, int? count, int? page, ESortOrder? order, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<EpochParamContentResponse> GetParametersAsync(int number);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/epochs/{number}/parameters", "0.1.27")]
        Task<EpochParamContentResponse> GetParametersAsync(int number, CancellationToken cancellationToken);
    }
}

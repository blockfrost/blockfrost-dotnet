...
namespace Blockfrost.Api.Extensions
{
    public static partial class BlockfrostServiceExtensions
    {
        ...
        /// <returns></returns>
        private static TService ServiceFactory<TService>(HttpClient client, string name, string network, int sockets = Constants.CONNECTION_LIMIT) where TService : ABlockfrostService
        {
        ...
        /// <param name="network"></param>
        /// <returns></returns>
        private static TService ServiceFactory<TService>(object migration, HttpClient client, string name, string network, int sockets = Constants.CONNECTION_LIMIT) where TService : ABlockfrostService
        {
            ConfigureHttpClient(client, network, sockets);

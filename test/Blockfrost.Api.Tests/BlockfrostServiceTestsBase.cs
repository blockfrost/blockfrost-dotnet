...
namespace Blockfrost.Api.Tests
{
    ...
    public abstract class BlockfrostServiceTestsBase : IBlockfrostService
    {
        ...
        Task<AnonymousResponse> IBlockfrostService.GetInfoAsync()
        {
            return Test.GetInfoAsync(EmptyToken);
        }

        Task<AnonymousResponse> IBlockfrostService.GetInfoAsync(CancellationToken cancellationToken)
        {
        ...
        Task<AccountContent> IBlockfrostService.GetAccountsAsync(string stake_address)
        {
            return Test.GetAccountsAsync(stake_address, EmptyToken);
        }

        Task<AccountContent> IBlockfrostService.GetAccountsAsync(string stake_address, CancellationToken cancellationToken)
        {
        ...
        Task<ICollection<AssetAddressesResponse>> IBlockfrostService.GetAssetAddressesAsync(string asset, int? count, int? page, SortOrder? order)
        {
            return Test.GetAssetAddressesAsync(asset, count, page, order, EmptyToken);
        }

        Task<ICollection<AssetAddressesResponse>> IBlockfrostService.GetAssetAddressesAsync(string asset, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<StakeAddressesAddressesResponse>> IBlockfrostService.AddressesAllAsync(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.AddressesAllAsync(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressesAddressesResponse>> IBlockfrostService.AddressesAllAsync(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<AssetsResponse>> IBlockfrostService.AssetsAll2Async(int? count, int? page, SortOrder? order)
        {
            return Test.AssetsAll2Async(count, page, order, EmptyToken);
        }

        Task<ICollection<AssetsResponse>> IBlockfrostService.AssetsAll2Async(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<StakeAddressAddressesAssetsResponse>> IBlockfrostService.AssetsAllAsync(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.AssetsAllAsync(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressAddressesAssetsResponse>> IBlockfrostService.AssetsAllAsync(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<string>> IBlockfrostService.BlocksAll2Async(int number, string pool_id, int? count, int? page, SortOrder? order)
        {
            return Test.BlocksAll2Async(number, pool_id, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.BlocksAll2Async(int number, string pool_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.BlocksAll3Async(string pool_id, int? count, int? page, SortOrder? order)
        {
            return Test.BlocksAll3Async(pool_id, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.BlocksAll3Async(string pool_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.BlocksAllAsync(int number, int? count, int? page, SortOrder? order)
        {
            return Test.BlocksAllAsync(number, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.BlocksAllAsync(int number, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<TxMetadataLabelCBORResponse>> IBlockfrostService.Cbor2Async(string label, int? count, int? page, SortOrder? order)
        {
            return Test.Cbor2Async(label, count, page, order, EmptyToken);
        }

        Task<ICollection<TxMetadataLabelCBORResponse>> IBlockfrostService.Cbor2Async(string label, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<TxMetadataCbor>> IBlockfrostService.CborAsync(string hash)
        {
            return Test.CborAsync(hash, EmptyToken);
        }

        Task<ICollection<TxMetadataCbor>> IBlockfrostService.CborAsync(string hash, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<StakeAddressDelegationsResponse>> IBlockfrostService.Delegations2Async(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.Delegations2Async(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressDelegationsResponse>> IBlockfrostService.Delegations2Async(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<PoolDelegatorResponse>> IBlockfrostService.DelegatorsAsync(string pool_id, int? count, int? page, SortOrder? order)
        {
            return Test.DelegatorsAsync(pool_id, count, page, order, EmptyToken);
        }

        Task<ICollection<PoolDelegatorResponse>> IBlockfrostService.DelegatorsAsync(string pool_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<PoolHistoryResponse>> IBlockfrostService.History2Async(string pool_id, int? count, int? page, SortOrder? order)
        {
            return Test.History2Async(pool_id, count, page, order, EmptyToken);
        }

        Task<ICollection<PoolHistoryResponse>> IBlockfrostService.History2Async(string pool_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<AssetHistoryResponse>> IBlockfrostService.History3Async(string asset, int? count, int? page, SortOrder? order)
        {
            return Test.History3Async(asset, count, page, order, EmptyToken);
        }

        Task<ICollection<AssetHistoryResponse>> IBlockfrostService.History3Async(string asset, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<StakeAddressHistoryResponse>> IBlockfrostService.HistoryAsync(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.HistoryAsync(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressHistoryResponse>> IBlockfrostService.HistoryAsync(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<TxMetadataLabelJsonResponse>> IBlockfrostService.Labels2Async(string label, int? count, int? page, SortOrder? order)
        {
            return Test.Labels2Async(label, count, page, order, EmptyToken);
        }

        Task<ICollection<TxMetadataLabelJsonResponse>> IBlockfrostService.Labels2Async(string label, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<TxMetadataLabelResponse>> IBlockfrostService.LabelsAsync(int? count, int? page, SortOrder? order)
        {
            return Test.LabelsAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<TxMetadataLabelResponse>> IBlockfrostService.LabelsAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<Anonymous32>> IBlockfrostService.ListAllAsync(int? count, int? page, SortOrder? order)
        {
            return Test.ListAllAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<Anonymous32>> IBlockfrostService.ListAllAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<TxMetadata>> IBlockfrostService.MetadataAllAsync(string hash)
        {
            return Test.MetadataAllAsync(hash, EmptyToken);
        }

        Task<ICollection<TxMetadata>> IBlockfrostService.MetadataAllAsync(string hash, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<StakeAddressMirsResponse>> IBlockfrostService.Mirs2Async(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.Mirs2Async(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressMirsResponse>> IBlockfrostService.Mirs2Async(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<Network> IBlockfrostService.NetworkAsync()
        {
            return Test.NetworkAsync(EmptyToken);
        }

        Task<Network> IBlockfrostService.NetworkAsync(CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<AssetPolicyResponse>> IBlockfrostService.PolicyAsync(string policy_id, int? count, int? page, SortOrder? order)
        {
            return Test.PolicyAsync(policy_id, count, page, order, EmptyToken);
        }

        Task<ICollection<AssetPolicyResponse>> IBlockfrostService.PolicyAsync(string policy_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.PoolsAllAsync(int? count, int? page, SortOrder? order)
        {
            return Test.PoolsAllAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.PoolsAllAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<Pool> IBlockfrostService.PoolsAsync(string pool_id)
        {
            return Test.PoolsAsync(pool_id, EmptyToken);
        }

        Task<Pool> IBlockfrostService.PoolsAsync(string pool_id, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<StakeAddressRegistrationsResponse>> IBlockfrostService.RegistrationsAsync(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.RegistrationsAsync(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressRegistrationsResponse>> IBlockfrostService.RegistrationsAsync(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<RetiredResponse>> IBlockfrostService.RetiredAsync(int? count, int? page, SortOrder? order)
        {
            return Test.RetiredAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<RetiredResponse>> IBlockfrostService.RetiredAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<RetiredResponse>> IBlockfrostService.RetiringAsync(int? count, int? page, SortOrder? order)
        {
            return Test.RetiringAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<RetiredResponse>> IBlockfrostService.RetiringAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<Anonymous9>> IBlockfrostService.RewardsAsync(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.RewardsAsync(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<Anonymous9>> IBlockfrostService.RewardsAsync(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<Anonymous>> IBlockfrostService.StakesAsync(int number, int? count, int? page)
        {
            return Test.StakesAsync(number, count, page, EmptyToken);
        }

        Task<ICollection<Anonymous>> IBlockfrostService.StakesAsync(int number, int? count, int? page, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<string> IBlockfrostService.SubmitAsync(ContentType content_Type)
        {
            return Test.SubmitAsync(content_Type, EmptyToken);
        }

        Task<string> IBlockfrostService.SubmitAsync(ContentType content_Type, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<NutlinkAddressTickerResponse>> IBlockfrostService.Tickers2Async(string address, string ticker, int? count, int? page, SortOrder? order)
        {
            return Test.Tickers2Async(address, ticker, count, page, order, EmptyToken);
        }

        Task<ICollection<NutlinkAddressTickerResponse>> IBlockfrostService.Tickers2Async(string address, string ticker, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<NutlinkTickersTickerResponse>> IBlockfrostService.Tickers3Async(string ticker, int? count, int? page, SortOrder? order)
        {
            return Test.Tickers3Async(ticker, count, page, order, EmptyToken); ;
        }

        Task<ICollection<NutlinkTickersTickerResponse>> IBlockfrostService.Tickers3Async(string ticker, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<NutlinkAddressTickersResponse>> IBlockfrostService.TickersAsync(string address, int? count, int? page, SortOrder? order)
        {
            return Test.TickersAsync(address, count, page, order, EmptyToken);
        }

        Task<ICollection<NutlinkAddressTickersResponse>> IBlockfrostService.TickersAsync(string address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        Task<ICollection<AssetTransactionResponse>> IBlockfrostService.Transactions2Async(string asset, int? count, int? page, SortOrder? order)
        {
            return Test.Transactions2Async(asset, count, page, order, EmptyToken);
        }

        Task<ICollection<AssetTransactionResponse>> IBlockfrostService.Transactions2Async(string asset, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<AddressTransactionResponse>> IBlockfrostService.TransactionsAsync(string address, int? count, int? page, SortOrder? order, string from, string to)
        {
            return Test.TransactionsAsync(address, count, page, order, from, to, EmptyToken);
        }

        Task<ICollection<AddressTransactionResponse>> IBlockfrostService.TransactionsAsync(string address, int? count, int? page, SortOrder? order, string from, string to, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll2Async(string hash_or_number, int? count, int? page, SortOrder? order)
        {
            return Test.TxsAll2Async(hash_or_number, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll2Async(string hash_or_number, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll3Async(string address, int? count, int? page, SortOrder? order)
        {
            return Test.TxsAll3Async(address, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll3Async(string address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll4Async(string asset, int? count, int? page, SortOrder? order)
        {
            return Test.TxsAll4Async(asset, count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.TxsAll4Async(string asset, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<string>> IBlockfrostService.TxsAllAsync(int? count, int? page, SortOrder? order)
        {
            return Test.TxsAllAsync(count, page, order, EmptyToken);
        }

        Task<ICollection<string>> IBlockfrostService.TxsAllAsync(int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<TxContent> IBlockfrostService.TxsAsync(string hash)
        {
            return Test.TxsAsync(hash, EmptyToken);
        }

        Task<TxContent> IBlockfrostService.TxsAsync(string hash, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<PoolUpdateResponse>> IBlockfrostService.UpdatesAsync(string pool_id, int? count, int? page, SortOrder? order)
        {
            return Test.UpdatesAsync(pool_id, count, page, order, EmptyToken);
        }

        Task<ICollection<PoolUpdateResponse>> IBlockfrostService.UpdatesAsync(string pool_id, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<AddressUTxOResponse>> IBlockfrostService.UtxosAllAsync(string address, int? count, int? page, SortOrder? order)
        {
            return Test.UtxosAllAsync(address, count, page, order, EmptyToken);
        }

        Task<ICollection<AddressUTxOResponse>> IBlockfrostService.UtxosAllAsync(string address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<TxContentUtxo> IBlockfrostService.UtxosAsync(string hash)
        {
            return Test.UtxosAsync(hash, EmptyToken);
        }

        Task<TxContentUtxo> IBlockfrostService.UtxosAsync(string hash, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        Task<ICollection<StakeAddressWithdrawalsResponse>> IBlockfrostService.Withdrawals2Async(string stake_address, int? count, int? page, SortOrder? order)
        {
            return Test.Withdrawals2Async(stake_address, count, page, order, EmptyToken);
        }

        Task<ICollection<StakeAddressWithdrawalsResponse>> IBlockfrostService.Withdrawals2Async(string stake_address, int? count, int? page, SortOrder? order, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

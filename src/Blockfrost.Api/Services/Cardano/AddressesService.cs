...
namespace Blockfrost.Api.Services
{
    public partial class AddressesService : ABlockfrostService, IAddressesService
    {
        ...
        public async Task<Models.AddressContentResponse> GetAddressesAsync(string address, CancellationToken cancellationToken = default)
        {
            if (address == null)
            {
        ...
        public async Task<Models.AddressContentTotalResponse> GetTotalAsync(string address, CancellationToken cancellationToken = default)
        {
            if (address == null)
            {
                throw new System.ArgumentNullException(nameof(address));
        ...
        public async Task<Models.AddressUtxoContentResponseCollection> GetUtxosAsync(string address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (address == null)
            {
                throw new System.ArgumentNullException(nameof(address));
        ...
        public async Task<Models.StringCollection> GetTxsAsync(string address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (address == null)
            {
                throw new System.ArgumentNullException(nameof(address));
        ...
        public async Task<Models.AddressTransactionsContentResponseCollection> GetTransactionsAsync(string address, string from, string to, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (address == null)
            {
                throw new System.ArgumentNullException(nameof(address));

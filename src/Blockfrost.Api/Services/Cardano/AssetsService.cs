...
namespace Blockfrost.Api.Services
{
    public partial class AssetsService : ABlockfrostService, IAssetsService
    {
        ...
        [Get("/assets", "0.1.28")]
        public async Task<Models.AssetsResponseCollection> GetAssetsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.AssetResponse> GetAssetsAsync(string asset, CancellationToken cancellationToken = default)
        {
            if (asset == null)
            {
        ...
        public async Task<Models.AssetHistoryResponseCollection> GetHistoryAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (asset == null)
            {
                throw new System.ArgumentNullException(nameof(asset));
        ...
        public async Task<Models.StringCollection> GetTxsAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (asset == null)
            {
                throw new System.ArgumentNullException(nameof(asset));
        ...
        public async Task<Models.AssetTransactionsResponseCollection> GetTransactionsAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (asset == null)
            {
                throw new System.ArgumentNullException(nameof(asset));
        ...
        public async Task<Models.AssetAddressesResponseCollection> GetAddressesAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (asset == null)
            {
                throw new System.ArgumentNullException(nameof(asset));
        ...
        public async Task<Models.AssetPolicyResponseCollection> GetPolicyAsync(string policy_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (policy_id == null)
            {

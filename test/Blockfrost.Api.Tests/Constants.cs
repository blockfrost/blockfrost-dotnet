namespace Blockfrost.Api.Tests
{
    internal static class Constants
    {
        ...
        public const string BFCLI_API_KEY = "BFCLI_API_KEY";
        public const string BFCLI_NETWORK = "BFCLI_NETWORK";
        public const string NETCORE_ENVIRONMENT = "NETCORE_ENVIRONMENT";
        public const string NETWORK_MAINNET = "mainnet";
        public const string NETWORK_OPFS = "ipfs";

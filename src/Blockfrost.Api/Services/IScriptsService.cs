...
namespace Blockfrost.Api.Services
{
    public partial interface IScriptsService : IBlockfrostService
    {
        ...
        [Get("/scripts", "0.1.28")]
        Task<Models.ScriptsResponseCollection> GetScriptsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.ScriptResponse> GetScriptsAsync(string script_hash, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.ScriptRedeemersResponseCollection> GetRedeemersAsync(string script_hash, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

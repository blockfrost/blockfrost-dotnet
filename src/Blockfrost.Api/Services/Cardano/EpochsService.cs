...
namespace Blockfrost.Api.Services
{
    public partial class EpochsService : ABlockfrostService, IEpochsService
    {
        ...
        public async Task<Models.EpochContentResponse> GetLatestAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochParamContentResponse> GetLatestParametersAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochContentResponse> GetEpochsAsync(int number, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochContentResponseCollection> GetNextAsync(int number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochContentResponseCollection> GetPreviousAsync(int number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochStakeContentResponseCollection> GetStakesAsync(int number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.EpochStakePoolContentResponseCollection> GetStakesAsync(int number, string pool_id, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
            if (pool_id == null)
            {
        ...
        public async Task<Models.StringCollection> GetBlocksAsync(int number, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.StringCollection> GetBlocksAsync(int number, string pool_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (pool_id == null)
            {
                throw new System.ArgumentNullException(nameof(pool_id));
        ...
        public async Task<Models.EpochParamContentResponse> GetParametersAsync(int number, CancellationToken cancellationToken = default)
        {

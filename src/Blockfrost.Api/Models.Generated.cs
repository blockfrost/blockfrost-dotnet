...
namespace Blockfrost.Api
{
    ...
    //{
    //    private string _baseUrl = "https://cardano-mainnet.blockfrost.io/api/v0/";
    ...
    //    public Task<ICollection<Anonymous38>> UpdatesAsync(string hash)
    //    {
    //        return UpdatesAsync(hash, CancellationToken.None);
    //    }
    ...
    //    /// <returns>Obtain information about stake pool certificates of a specific transaction</returns>
    //    /// <exception cref="ApiException">A server side error occurred.</exception>
    //    public async Task<ICollection<Anonymous38>> UpdatesAsync(string hash, CancellationToken cancellationToken)
    //    {
    //        if (hash == null)
    //            throw new System.ArgumentNullException("hash");

    //        var urlBuilder_ = new System.Text.StringBuilder();
    //        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/txs/{hash}/pool_updates");
    ...
    //                    if (status_ == 200)
    //                    {
    //                        var objectResponse_ = await ReadObjectResponseAsync<ICollection<Anonymous38>>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    //    /// <exception cref="ApiException">A server side error occurred.</exception>
    //    public Task<ICollection<Anonymous39>> RetiresAsync(string hash)
    //    {
    //        return RetiresAsync(hash, CancellationToken.None);
    //    }
    ...
    //    /// <returns>Obtain information about stake pool retirements within a specific transaction.</returns>
    //    /// <exception cref="ApiException">A server side error occurred.</exception>
    //    public async Task<ICollection<Anonymous39>> RetiresAsync(string hash, CancellationToken cancellationToken)
    //    {
    //        if (hash == null)
    //            throw new System.ArgumentNullException("hash");

    //        var urlBuilder_ = new System.Text.StringBuilder();
    //        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/txs/{hash}/pool_retires");
    //        urlBuilder_.Replace("{hash}", System.Uri.EscapeDataString(ConvertToString(hash, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    //                    if (status_ == 200)
    //                    {
    //                        var objectResponse_ = await ReadObjectResponseAsync<ICollection<Anonymous39>>(response_, headers_, cancellationToken).ConfigureAwait(false);
    //                        if (objectResponse_.Object == null)
    //                        {
    //                            throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
    //                        }
    ...
    public partial class Block_content_array : System.Collections.ObjectModel.Collection<Block_content>
    {

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class Block_content
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class Block_content_txs : System.Collections.ObjectModel.Collection<string>
    {
    ...
    {
        [Newtonsoft.Json.JsonProperty("server_time", Required = Newtonsoft.Json.Required.Always)]

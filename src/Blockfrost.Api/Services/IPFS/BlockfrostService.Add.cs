...
namespace Blockfrost.Api
{
    public partial class BlockfrostService : IBlockfrostService
    {
        ...
        public Task<IpfsAddResponse> AddAsync()
        {
            return AddAsync(CancellationToken.None);
        }
        ...
        /// <returns>Returns information about added IPFS object</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async Task<IpfsAddResponse> AddAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IpfsAddResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);

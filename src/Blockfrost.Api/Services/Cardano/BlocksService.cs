...
namespace Blockfrost.Api.Services
{
    public partial class BlocksService : ABlockfrostService, IBlocksService
    {
        ...
        public async Task<Models.BlockContentResponse> GetLatestAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.StringCollection> GetLatestTxsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.BlockContentResponse> GetBlocksAsync(string hash_or_number, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.BlockContentResponse> GetSlotAsync(int slot_number, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.BlockContentResponse> GetEpochSlotAsync(int epoch_number, int slot_number, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.BlockContentResponseCollection> GetNextAsync(string hash_or_number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
            if (hash_or_number == null)
            {
                throw new System.ArgumentNullException(nameof(hash_or_number));
        ...
        public async Task<Models.BlockContentResponseCollection> GetPreviousAsync(string hash_or_number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default)
        {
            if (hash_or_number == null)
            {
                throw new System.ArgumentNullException(nameof(hash_or_number));
        ...
        public async Task<Models.StringCollection> GetTxsAsync(string hash_or_number, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (hash_or_number == null)
            {
                throw new System.ArgumentNullException(nameof(hash_or_number));

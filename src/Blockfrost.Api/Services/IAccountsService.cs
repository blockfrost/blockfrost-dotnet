...
namespace Blockfrost.Api.Services
{
    public partial interface IAccountsService : IBlockfrostService
    {
        ...
        Task<Models.AccountContentResponse> GetAccountsAsync(string stake_address, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountRewardContentResponseCollection> GetRewardsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountHistoryContentResponseCollection> GetHistoryAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountDelegationContentResponseCollection> GetDelegationsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountRegistrationContentResponseCollection> GetRegistrationsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountWithdrawalContentResponseCollection> GetWithdrawalsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountMirContentResponseCollection> GetMirsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountAddressesContentResponseCollection> GetAddressesAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AccountAddressesAssetsResponseCollection> GetAddressesAssetsAsync(string stake_address, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

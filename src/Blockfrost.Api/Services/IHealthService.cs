...
namespace Blockfrost.Api.Services
{
    public partial interface IHealthService : IBlockfrostService
    {
        ...
        [Get("/", "0.1.28")]
        Task<Models.InfoResponse> GetApiInfoAsync(CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/health", "0.1.28")]
        Task<Models.HealthResponse> GetHealthAsync(CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.HealthClockResponse> GetClockAsync(CancellationToken cancellationToken = default);
    }
}

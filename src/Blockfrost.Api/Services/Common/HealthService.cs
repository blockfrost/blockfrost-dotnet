...
namespace Blockfrost.Api.Services
{
    public partial class HealthService : ABlockfrostService, IHealthService
    {
        ...
        [Get("/", "0.1.28")]
        public async Task<Models.InfoResponse> GetApiInfoAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [Get("/health", "0.1.28")]
        public async Task<Models.HealthResponse> GetHealthAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.HealthClockResponse> GetClockAsync(CancellationToken cancellationToken = default)
        {

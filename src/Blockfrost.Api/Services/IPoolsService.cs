...
namespace Blockfrost.Api.Services
{
    public partial interface IPoolsService : IBlockfrostService
    {
        ...
        [Get("/pools", "0.1.28")]
        Task<Models.StringCollection> GetPoolsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolListRetireResponseCollection> GetRetiredAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolListRetireResponseCollection> GetRetiringAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolResponse> GetPoolsAsync(string pool_id, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolHistoryResponseCollection> GetHistoryAsync(string pool_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolMetadataResponse> GetMetadataAsync(string pool_id, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolRelaysResponseCollection> GetRelaysAsync(string pool_id, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolDelegatorsResponseCollection> GetDelegatorsAsync(string pool_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.StringCollection> GetBlocksAsync(string pool_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.PoolUpdatesResponseCollection> GetUpdatesAsync(string pool_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

...
namespace Blockfrost.Api.Services
{
    public partial interface IBlocksService : IBlockfrostService
    {
        ...
        Task<Models.BlockContentResponse> GetLatestAsync(CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.StringCollection> GetLatestTxsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.BlockContentResponse> GetBlocksAsync(string hash_or_number, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.BlockContentResponse> GetSlotAsync(int slot_number, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.BlockContentResponse> GetEpochSlotAsync(int epoch_number, int slot_number, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.BlockContentResponseCollection> GetNextAsync(string hash_or_number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.BlockContentResponseCollection> GetPreviousAsync(string hash_or_number, int? count = 100, int? page = 1, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.StringCollection> GetTxsAsync(string hash_or_number, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

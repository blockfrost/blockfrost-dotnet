...
namespace Blockfrost.Api.Services
{
    public partial class MetadataService : ABlockfrostService, IMetadataService
    {
        ...
        public async Task<Models.TxMetadataLabelsResponseCollection> GetTxsLabelsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Models.TxMetadataLabelJsonResponseCollection> GetTxsLabelsAsync(string label, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (label == null)
            {
        ...
        public async Task<Models.TxMetadataLabelCborResponseCollection> GetTxsLabelsCborAsync(string label, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default)
        {
            if (label == null)
            {
                throw new System.ArgumentNullException(nameof(label));

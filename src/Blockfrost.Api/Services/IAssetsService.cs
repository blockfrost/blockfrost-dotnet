...
namespace Blockfrost.Api.Services
{
    public partial interface IAssetsService : IBlockfrostService
    {
        ...
        [Get("/assets", "0.1.28")]
        Task<Models.AssetsResponseCollection> GetAssetsAsync(int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AssetResponse> GetAssetsAsync(string asset, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AssetHistoryResponseCollection> GetHistoryAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.StringCollection> GetTxsAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AssetTransactionsResponseCollection> GetTransactionsAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AssetAddressesResponseCollection> GetAddressesAsync(string asset, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<Models.AssetPolicyResponseCollection> GetPolicyAsync(string policy_id, int? count = 100, int? page = 1, ESortOrder? order = ESortOrder.Asc, CancellationToken cancellationToken = default);
    }
}

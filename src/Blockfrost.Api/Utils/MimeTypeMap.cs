...
namespace Blockfrost.Api.Utils
{
    ...
    /// </summary>
    /// <remarks>
    /// source: https://github.com/samuelneff/MimeTypeMap/blob/master/MimeTypeMap.cs
    /// </remarks>
    public static class MimeTypeMap
    {
        ...
        private static readonly Lazy<IDictionary<string, string>> s_mappings = new(BuildMappings);
        ...
        public static bool TryGetMimeType(string str, out string mimeType)
        {
            ...
            if (!str.StartsWith(Dot, StringComparison.InvariantCultureIgnoreCase))
            {
                int index = str.LastIndexOf(Dot, StringComparison.InvariantCultureIgnoreCase);
                ...
                return s_mappings.Value.TryGetValue(str, out mimeType);
            }
            return s_mappings.Value.TryGetValue(str, out mimeType);
        }
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound = true)
        {
            ...
            if (mimeType.StartsWith(Dot, StringComparison.InvariantCultureIgnoreCase))
            {
